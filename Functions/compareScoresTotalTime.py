...
for group in groups:
    for asset in group['assets']:
        ...
        for profile in assetProfiles:
            ...
            output1 = json.load(open(sys.argv[1]+'/scores/engagementTotalTime/'+profile+'.json'))
            output2 = json.load(open(sys.argv[1]+'output/scores/engagementTotalTime/'+profile+'.json'))
